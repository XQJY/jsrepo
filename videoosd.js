define(["exports", "./../modules/common/playback/playbackmanager.js", "./../modules/focusmanager.js", "./../modules/cardbuilder/cardbuilder.js", "./../modules/common/imagehelper.js", "./../modules/dom.js", "./../modules/browser.js", "./../modules/common/globalize.js", "./../modules/common/datetime.js", "./../modules/layoutmanager.js", "./../modules/common/itemmanager/itemmanager.js", "./../modules/loading/loading.js", "./../modules/emby-apiclient/events.js", "./../modules/emby-apiclient/connectionmanager.js", "./../modules/appheader/appheader.js", "./../modules/mediainfo/mediainfo.js", "./../modules/backdrop/backdrop.js", "./playqueue.js", "./tvplayqueue.js", "./lyrics.js", "./../modules/approuter.js", "./../modules/itemcontextmenu.js", "./../modules/shortcuts.js", "./../modules/common/inputmanager.js", "./../modules/common/usersettings/usersettings.js", "./../modules/input/mouse.js", "./../modules/emby-elements/emby-scroller/emby-scroller.js", "./../modules/emby-elements/emby-button/paper-icon-button-light.js", "./../modules/emby-elements/emby-tabs/emby-tabs.js", "./../modules/emby-elements/emby-slider/emby-slider.js", "./../modules/common/appsettings.js", "./../modules/common/servicelocator.js", "./../modules/input/keyboard.js", "./../modules/viewmanager/baseview.js", "./../modules/playback/osdcontroller.js", "./../modules/common/playback/playersettingsmenu.js"], function(_exports, _playbackmanager, _focusmanager, _cardbuilder, _imagehelper, _dom, _browser, _globalize, _datetime, _layoutmanager, _itemmanager, _loading, _events, _connectionmanager, _appheader, _mediainfo, _backdrop, _playqueue, _tvplayqueue, _lyrics, _approuter, _itemcontextmenu, _shortcuts, _inputmanager, _usersettings, _mouse, _embyScroller, _paperIconButtonLight, _embyTabs, _embySlider, _appsettings, _servicelocator, _keyboard, _baseview, _osdcontroller, _playersettingsmenu) {
    ...
    function focusMainOsdControls(instance) {
        ...
        elem.disabled ? _focusmanager.default.autoFocus(instance.videoOsdBottomMaincontrols) : _focusmanager.default.focus(elem)
    }
    ...
    function onOsdClick(e, instance, elementToFocusIfShowing, showOsdIfNoEvent) {
        ...
        if (target.closest(".videoOsdBottom"))
            ...
            0 <= instance.bottomTabs.selectedIndex() ? instance.bottomTabs.selectedIndex(-1) : (console.log("videoosd - playPause from onOsdClick"),
    ...
    function startOsdHideTimer(instance, timeoutMs) {
        ...
        instance.paused || !(isLocalVideo = isDisplayingLocalVideo(instance.currentPlayer)) || 0 === timeoutMs || _focusmanager.default.hasExclusiveFocusScope() || (instance.osdHideTimeout = setTimeout(instance.boundOnOsdHideTimeout, timeoutMs || (isLocalVideo ? 1e3 : 1e3)))
    }
    ...
    function confirmPlaybackCorrection(instance) {
        var player, wasPaused, options;
        return _usersettings.default.get("confirmplaybackcorrection", !1) ? Promise.resolve() : (player = instance.currentPlayer,
        (wasPaused = _playbackmanager.default.paused(player)) || _playbackmanager.default.pause(player),
        options = {
        ...
        Emby.importModule("./modules/common/dialogs/confirm.js").then(function(confirm) {
            return confirm(options)
        }).then(function() {
            return Promise.resolve()
        }, function() {
            return wasPaused || _playbackmanager.default.unpause(player),
            Promise.reject()
        }))
    }
    function showSubtitleOffset(instance) {
        Emby.importModule("./modules/subtitleoffsetoverlay/subtitleoffsetoverlay.js").then(function(SubtitleOffsetOverlay) {
            var positionTo, player = instance.currentPlayer;
            player && !instance.subtitleOffsetOverlay && (positionTo = instance.btnSubtitles,
            instance.subtitleOffsetOverlay = new SubtitleOffsetOverlay(Object.assign(getBaseActionSheetOptions(positionTo, !0), {
                player: player
            })),
            SubtitleOffsetOverlay = function() {
                var _instance$subtitleOff;
                null != (_instance$subtitleOff = instance.subtitleOffsetOverlay) && _instance$subtitleOff.destroy(),
                instance.subtitleOffsetOverlay = null
            }
            ,
            instance.subtitleOffsetOverlay.show().then(SubtitleOffsetOverlay, SubtitleOffsetOverlay))
        })
    }
    function onMoreClick(e) {
        e = e.target;
        showMoreMenu(this.osdController.currentItem, e, isDisplayingLocalVideo(this.currentPlayer))
    }
    function onSettingsOption(selectedOption) {
        var instance = this.instance
          , button = this.button
          , player = instance.currentPlayer;
        "stats" === selectedOption ? toggleStats(instance) : "subtitleoffset" === selectedOption ? showSubtitleOffset(instance) : "more" === selectedOption ? onMoreClick.call(instance, {
            target: button
        }) : "triggertranscodingfallback" === selectedOption && function(instance, player) {
    ...
    function onSettingsButtonClick(e) {
        var mediaType, isLocalVideo, e = e.target, player = this.currentPlayer;
        player && !_focusmanager.default.hasExclusiveFocusScope() && (isLocalVideo = isDisplayingLocalVideo(player, mediaType = this.osdController.currentItem.MediaType),
        _playersettingsmenu.default.show(Object.assign(getBaseActionSheetOptions(e, isLocalVideo), {
            player: player,
            stats: !0,
            ...
            more: isLocalVideo
        })).then(this.boundShowOsdDefaultParams, this.boundShowOsdDefaultParams))
    }
    function showAudioTrackSelection(e) {
        var currentIndex, audioTracks, instance = this, e = e.target, player = instance.currentPlayer;
        ...
        e = e,
        instance.showOsd(),
        showActionSheet(Object.assign(getBaseActionSheetOptions(e, !0), {
            items: audioTracks,
    ...
    function supportsSubtitleDownloading(instance) {
    ...
    function showSubtitleTrackSelection(e) {
        ...
        _itemmanager.default.getDefaultIcon({
          ...
          , positionTo = e
          , currentItem = instance.osdController.currentItem
          , streams = _connectionmanager.default.getApiClient(currentItem);
        streams.getCurrentUser().then(function(user) {
            supportsSubtitleDownloading(instance) && _itemmanager.default.canDownloadSubtitles(currentItem, user) && menuItems.push({
            ...
            showActionSheet(Object.assign(getBaseActionSheetOptions(positionTo, !0), {
                ...
                instance.showOsd(),
                "search" === id ? function(instance, item, mediaSource) {
                    Promise.all([Emby.importModule("./modules/registrationservices/registrationservices.js"), Emby.importModule("./modules/subtitleeditor/subtitleeditor.js")]).then(function(responses) {
                        return responses[0].validateFeature("sync").then(function() {
                            return responses[1].show({
                                ...
                                instance.showOsd(),
                                _playbackmanager.default.setSubtitleStreamIndex(result.NewIndex, instance.currentPlayer, !0)
                            }, instance.boundShowOsdDefaultParams)
                        })
                    })
                }(instance, currentItem, instance.osdController.currentMediaSource) : "subtitleoffset" === id ? showSubtitleOffset(instance) : (id = parseInt(id)) !== currentIndex && _playbackmanager.default.setSubtitleStreamIndex(id, player)
            }, instance.boundShowOsdDefaultParams)
        })
    }
    var focusOnTabChange = !1;
    function VideoOsd(view, params) {
        _baseview.default.apply(this, arguments);
        var comingUpNextDisplayed, isEnabled, currentIntroInfo, currentCreditsInfo, skipIntroValidated, enableAutoSkipIntro, lastPointerUpType, currentOsdContentSectionName, self = this, currentRuntimeTicks = (this.currentPlayerSupportedCommands = [],
        0), lastUpdateTime = 0, ratingTextNeedsUpdate = !0, brightnessSlider = (this.currentLockState = 0,
        ...
        _layoutmanager.default.tv && _appsettings.default.videoPlayerLongPressAction() && this.nowPlayingPositionSlider.classList.add("longpress", "dynamicKeyDownTarget"),
        this.nowPlayingVolumeSlider = view.querySelector(".videoOsdVolumeSlider"),
        view.querySelector(".videoOsdPositionText")), videoOsdDurationText = view.querySelector(".videoOsdDurationText"), rewindButtons = (this.videoOsdBottomMaincontrols = view.querySelector(".videoOsdBottom-maincontrols"),
        ...
        _events.default.on(this.osdController, "displayitemupdated", function(e, item, displayItem, state) {
            ...
            apiClient.getCurrentUser().then(function(user) {
                ...
                setElementDisabled(self.nowPlayingVolumeSlider, !1),
                "Video" === item.MediaType || item.SupportsResume) {
                    for (var _i8 = 0, _length8 = fastForwardButtons.length; _i8 < _length8; _i8++)
                        ...
                        setElementDisabled(fastForwardButtons[_i8], !0 === state.IsInitialRequest);
                    for (var _i9 = 0, _length9 = rewindButtons.length; _i9 < _length9; _i9++)
                        rewindButtons[_i9].classList.remove("hide"),
                        setElementDisabled(rewindButtons[_i9], !0 === state.IsInitialRequest)
                } else {
                ...
                1 < _playbackmanager.default.audioTracks(player).length ? self.btnAudio.classList.remove("hide") : self.btnAudio.classList.add("hide"),
                ...
                "Video" === item.MediaType && (_playbackmanager.default.subtitleTracks(player).length || _itemmanager.default.canDownloadSubtitles(item, user) && supportsSubtitleDownloading(self)) ? self.btnSubtitles.classList.remove("hide") : self.btnSubtitles.classList.add("hide")
            }))
        }),
        ...
        view.querySelector(".videoOsd-belowtransportbuttons")), btnPreviousTrack = view.querySelector(".btnPreviousTrack"), btnNextTrack = view.querySelector(".btnNextTrack"), buttonMute = view.querySelector(".buttonMute"), btnFullscreen = (this.btnSubtitles = view.querySelector(".btnSubtitles"),
        this.btnAudio = view.querySelector(".btnAudio"),
        view.querySelector(".btnFullscreen")), videoOsdSecondaryText = view.querySelector(".videoOsdSecondaryText"), videoOsdBottomButtons = (this.videoOsdText = view.querySelector(".videoOsdText"),
        ...
        _itemmanager.default.getDefaultIcon({
            Type: "MediaStream",
            StreamType: "Subtitle"
        })), videoOsdDurationText = view.querySelector(".subtitleIcon");
        "&#xe8cd;" === videoOsdPositionText && videoOsdDurationText.classList.add("md-icon-pushdown-bubble"),
        videoOsdDurationText.innerHTML = videoOsdPositionText,
        ...
        function updateRecordingButton(item, user) {
            item && "Program" === item.Type ? user.Policy.EnableLiveTvManagement && Emby.importModule("./modules/recordingcreator/recordingbutton.js").then(function(RecordingButton) {
        ...
        function updateButtomTabsVisibility(item, displayItem) {
            ...
            ("Video" === item.MediaType ? apiClient.getUserViews({}, apiClient.getCurrentUserId()) : Promise.resolve({
                ...
                self.bottomTabs)
                  , result = (view.querySelector(".videoosd-tab-button:not(.hide)") ? (self.tabContainersElem.classList.remove("hide"),
                _self$osdController$c.classList.remove("hide")) : (self.tabContainersElem.classList.add("hide"),
        ...
        function updateTransparency(player, state, mediaType, isLocalVideo) {
            ...
            if (isLocalVideo) {
                ...
                _layoutmanager.default.tv ? (function() {
                    var val;
                    if (!_appsettings.default.enableVideoUnderUI())
                        return "true" === (val = _appsettings.default.hideMediaTransportButtons()) ? 1 : "false" !== val && !_mouse.default.lastMouseInputTime()
                ...
                hideOrShowAll(self, stopButtons, !_layoutmanager.default.tv || !_appsettings.default.enableVideoUnderUI(), null),
                ...
                null != (instance = state.NowPlayingItem) && instance.SupportsResume ? (videoOsdBottomButtons.classList.add("videoOsd-customFont-remotecontrol-buttons"),
                videoOsdBottomButtons.classList.remove("videoOsd-customFont-remotecontrol-buttons-largeportrait")) : videoOsdBottomButtons.classList.add("videoOsd-customFont-remotecontrol-buttons", "videoOsd-customFont-remotecontrol-buttons-largeportrait"),
            ...
            self.playQueue || (player = _usersettings.default.osdContentSection() || getDefaultOsdContentSection(),
            _layoutmanager.default.tv ? (self.playQueue = new _tvplayqueue.default({
                parent: view.querySelector(".videoOsdBottom")
            }),
            player = "playqueue") : self.playQueue = new _playqueue.default({
                parent: view.querySelector(".videoOsdBottom")
            }),
            setContentSection(player = "lyrics" === player ? getDefaultOsdContentSection() : player, !1)));
            ...
            mediaType.classList.add("videoOsd-btnPause-autolayout")) : (mainTransportButtons.classList.remove("videoOsd-centerButtons-autolayout"),
        ...
        function onStateChanged(event, state) {
            ...
            function(event, player, state) {
                ...
                for (var _i12 = 0, _length12 = fastForwardButtons.length; _i12 < _length12; _i12++)
                    setElementDisabled(fastForwardButtons[_i12], !playState.CanSeek);
                for (var _i13 = 0, _length13 = rewindButtons.length; _i13 < _length13; _i13++)
                    setElementDisabled(rewindButtons[_i13], !playState.CanSeek);
                ...
                function(state) {
                    if (!state.NowPlayingItem) {
                        ...
                        setElementDisabled(self.nowPlayingVolumeSlider, !0);
        ...
        function onVolumeChanged(e) {
            isEnabled && updatePlayerVolumeState(0, this.isMuted(), this.getVolume(), self.currentPlayerSupportedCommands)
        }
        ...
        function onPlaybackStart(e, state) {
            ...
            self.osdController.onPlaybackStart(e, this, state),
        ...
        (videoOsdDurationText = osdPosterContainer).fetchData = getDetailImageItems,
        videoOsdDurationText.getListOptions = getDetailImageListOptions,
        ...
        var IntroEndToleranceTicksDefault = 2e7
          , IntroEndToleranceTicksSafe = 5e7
        ...
        function showHideSkipIntro(show, resetIntroEndTolerance) {
            ...
            !1 !== resetIntroEndTolerance && (IntroEndToleranceTicks = IntroEndToleranceTicksDefault))
        }
        ...
        function onTimeUpdate(e) {
            ...
            function(currentTime) {
                ...
                introInfo && (currentTime <= introInfo.start && (IntroEndToleranceTicks = IntroEndToleranceTicksDefault),
                enableSkipIntro) && currentTime >= introInfo.start && currentTime < introInfo.end - IntroEndToleranceTicks && (!1 !== skipIntroValidated || _appsettings.default.introSkipDisplayCount() < 5) ? (!0 === skipIntroValidated && _appsettings.default.introSkipDisplayCount(0),
                showHideSkipIntro(!0)) : showHideSkipIntro(!1, !1)
            }(currentTime),
            function() {
                var item;
        ...
        function updatePlayPauseState(isPaused, isInitialRequest) {
            ...
            setElementDisabled(btnPause, !0 === isInitialRequest),
            self.playQueue);
        ...
        function setElementDisabled(btn, disabled) {
            ...
            (btn.disabled = disabled) && isFocused && focusMainOsdControls(self)
        }
        ...
        function onSkipIntroClickInternal() {
            var info = currentIntroInfo
              , player = self.currentPlayer;
            info && player && (IntroEndToleranceTicks = IntroEndToleranceTicksSafe,
            _playbackmanager.default.seek(info.end, player),
            showHideSkipIntro(!1, !1),
            self.hideOsd())
        }
        ...
        _dom.default.addEventListener(btnPlaybackSpeed, "click", function() {
            var mediaType, isLocalVideo, player = self.currentPlayer;
            player && (isLocalVideo = isDisplayingLocalVideo(player, mediaType = self.osdController.currentItem.MediaType),
            _playersettingsmenu.default.showSpeedMenu(Object.assign(getBaseActionSheetOptions(this, isLocalVideo), {
                player: player,
                mediaType: mediaType
        ...
        self.bottomTabs.addEventListener("beforetabchange", function(e) {
            ...
            self.tabContainersElem.offsetWidth,
            ...
            }(newPanel))) : (self.tabContainersElem.classList.add("videoosd-tabcontainers-hidden"),
        ...
        _layoutmanager.default.tv && view.querySelector(".btnPlayNextFromUpNext").classList.add("btnPlayNextFromUpNext-tv"),
        ...
        this.boundOnOsdHideTimeout = function() {
            _focusmanager.default.hasExclusiveFocusScope() || 0 <= this.bottomTabs.selectedIndex() && this.tabContainersElem.contains(document.activeElement) ? startOsdHideTimer(this) : this.mouseOverButton || this.nowPlayingPositionSlider.dragging || this.nowPlayingVolumeSlider.dragging || this.hideOsd()
        }
        .bind(this)
    }
    ...
    VideoOsd.prototype.onWindowInputCommand = function(e) {
        ...
        case "playpause":
            ...
            return console.log("videoosd - playPause from playpause command"),
        ...
        case "up":
            return void function(instance, e) {
                instance.currentVisibleMenu || instance.upNextContainer._visible || "chapters" !== _usersettings.default.videoScreenUpAction() || !canSetBottomTabIndex(instance, 1) || e.target.closest(".view") ? shouldOsdBeShown(instance) && instance.showOsd() : (focusOnTabChange = !0,
        ...
        case "down":
            ...
            this.showOsd()));
        case "menu":
            if (e.detail.repeat && !this.nowPlayingPositionSlider.dragging && _layoutmanager.default.tv)
                ...
                case "settings":
                    ...
                    void onSettingsButtonClick.call(this, {
                        target: this.btnVideoOsdSettingsRight
                    });
                case "audio":
                    return shouldOsdBeShown(this) && this.showOsd(),
                    void (this.btnAudio.classList.contains("hide") || showAudioTrackSelection.call(this, {
                        target: this.btnAudio
                    }));
                case "subtitles":
                    return shouldOsdBeShown(this) && this.showOsd(),
                    void (this.btnSubtitles.classList.contains("hide") || showSubtitleTrackSelection.call(this, {
                        target: this.btnSubtitles
                    }))
                }
    ...
    VideoOsd.prototype.onResume = function(options) {
        ...
        this.nowPlayingPositionSlider.classList.contains("longpress") && document.body.classList.add("longpress"),
        ...
        isLocalVideo = (isLocalVideo = this.boundWindowKeyDown) || (this.boundWindowKeyDown = function(e) {
            ...
            switch (key) {
            case " ":
                return _focusmanager.default.hasExclusiveFocusScope() ? void 0 : (this.currentVisibleMenu && !target.closest(".videoOsdPositionSlider") && this.showOsd(),
                void (target.closest("BUTTON") || e.repeat || this.nowPlayingPositionSlider.dragging || (console.log("videoosd - playPause from onWindowKeyDown"),
                _playbackmanager.default.playPause(this.currentPlayer),
    ...
    VideoOsd.prototype.onPause = function(options) {
        ...
        null != (statsOverlay = this.currentPlayer) && statsOverlay.isLocalPlayer && _appsettings.default.enableVideoUnderUI() ? _approuter.default.setTransparency("backdrop") : _playbackmanager.default.stop(statsOverlay)),
